...
export class CategoryFormComponent implements OnInit {
  ...
  getErrorTitleMessage(): any {
    if (this.title.hasError('required')) {
      return 'Title is required'
    }
    if (this.title.hasError('maxlength') && !this.title.hasError('required')) {
  ...
  getErrorCssMessage(): any {
    if (this.css_color.hasError('required')) {
      return 'Css color is required'
    }
    if (this.css_color.hasError('maxlength') && !this.css_color.hasError('required')) {
